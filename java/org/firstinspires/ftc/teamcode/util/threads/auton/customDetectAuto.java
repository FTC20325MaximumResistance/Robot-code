...
//@Disabled
@Autonomous(name = "Detection Auto", group = "Auto")
public class customDetectAuto extends LinearOpMode {
    ...
    public void runOpMode()
    {
            ...
            if(currentDetections.size() != 0)
            {
                ...
                for(AprilTagDetection tag : currentDetections)
                {
                    if(tag.id == LEFT || tag.id == MIDDLE || tag.id == RIGHT)
                    {
                        tagOfInterest = tag;
                        tagFound = true;
                        telemetry.addData("Direction", tagOfInterest.id);
                        telemetry.update();
                        r.waiter(5000);
                        break;
                    }
        ...
        /*8opiiuoutyiuoutryiuop;iooiu i am sentient
        ][
        it
